...
**[Vet Clinic Database]** is a relational database that contains data for a vet clinic. Its aim is to store animals information, insert data into it and query it.
